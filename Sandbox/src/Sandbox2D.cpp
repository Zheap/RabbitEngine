...
void Sandbox2D::OnUpdate(Rabbit::Timestep ts)
{
...

    {
        ...
        Rabbit::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckedboardTexture, 10.0f);
        Rabbit::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, m_CheckedboardTexture, 20.0f);
