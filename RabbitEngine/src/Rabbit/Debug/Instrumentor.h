...
#define RB_PROFILE 1
    ...
    #define RB_FUNC_SIG __func__
    #else
    #define RB_FUNC_SIG "RB_FUNC_SIG unknown!"
    #endif

    #define RB_PROFILE_BEGIN_SESSION(name, filepath) ::Rabbit::Instrumentor::Get().BeginSession(name, filepath)
    #define RB_PROFILE_END_SESSION() ::Rabbit::Instrumentor::Get().EndSession()
    #define RB_PROFILE_SCOPE(name)  ::Rabbit::InstrumentationTimer timer##__LINE__(name);
